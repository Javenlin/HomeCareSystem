package com.osiog.homecaresystem.PillAlarm;
...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.z_list_item, null);
        }
        ...
        int colorSelected = Color.parseColor("#3052a8");
        // The colors indicates the days of week when the alarm doesn't go off
        int colorNotSelected = Color.parseColor("#00e0b3");
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this._context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.z_list_group, null);
        }
